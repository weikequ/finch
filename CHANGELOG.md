...
## [0.7.0](https://github.com/weikequ/finch/compare/v0.6.2...v0.7.0) (2023-06-16)


### ⚠ BREAKING CHANGES

* persists nerdctl user data ([#182](https://github.com/weikequ/finch/issues/182))
* changes persistent disk path to prevent collisions

### Features

* add `finch cp` command ([#135](https://github.com/weikequ/finch/issues/135)) ([5989361](https://github.com/weikequ/finch/commit/598936166c6fd4a6999e4d3e8d074447e122aea7))
* add `finch vm status` command ([#83](https://github.com/weikequ/finch/issues/83)) ([37d74d0](https://github.com/weikequ/finch/commit/37d74d0b82c41f439715d0a07e723fd5e5a9a617))
* add config to support additional directories ([#128](https://github.com/weikequ/finch/issues/128)) ([0ceb060](https://github.com/weikequ/finch/commit/0ceb0602c6e1b90b25fa9de19303ea6ccdece6d7))
* add experimental support for Cosign signing and verification ([#296](https://github.com/weikequ/finch/issues/296)) ([84c2634](https://github.com/weikequ/finch/commit/84c2634b7c1226ba9746d0cda4d22ec571454160))
* adds a --force flag to vm stop and remove ([#178](https://github.com/weikequ/finch/issues/178)) ([d499a7d](https://github.com/weikequ/finch/commit/d499a7d712bcc726f331ff07f0e0855ddc9046fa))
* adds support bundles ([#210](https://github.com/weikequ/finch/issues/210)) ([cc6be65](https://github.com/weikequ/finch/commit/cc6be6577c97697e99112a7b693eff2664b747ef))
* Print version with Client and Server ([#108](https://github.com/weikequ/finch/issues/108)) ([7f7cdda](https://github.com/weikequ/finch/commit/7f7cdda1d21e430c259eb24a82c6b5784606cbac))
* saves containerd user data to a persistent disk ([#133](https://github.com/weikequ/finch/issues/133)) ([fccb4f3](https://github.com/weikequ/finch/commit/fccb4f3530b5abc7943db921c25c4f01ea76d725))
* Support special IP host-gateway in --add-host flag ([#216](https://github.com/weikequ/finch/issues/216)) ([9a38c8e](https://github.com/weikequ/finch/commit/9a38c8e6bc8aa155cda0cdc5b4d80bb12bac8eb8))


### Bug Fixes

* Add cleanup script to Makefile ([#444](https://github.com/weikequ/finch/issues/444)) ([da91f87](https://github.com/weikequ/finch/commit/da91f87369e5fde221b8edbac374954e71dae947))
* always force stop when using Virtualization.framework ([#350](https://github.com/weikequ/finch/issues/350)) ([c521f1f](https://github.com/weikequ/finch/commit/c521f1f65d406094c653b7a78d0009285b9fc627))
* changes persistent disk path to prevent collisions ([3eb66a2](https://github.com/weikequ/finch/commit/3eb66a21bcbf56dd8e4465bfc3ed840903b069d9))
* Configure Buildkit Namespace as Env Variable ([#129](https://github.com/weikequ/finch/issues/129)) ([ffb90be](https://github.com/weikequ/finch/commit/ffb90beeeeef7cb8db5706f9198e06d6e111f53f))
* correctly handle local environment value pass-through ([#158](https://github.com/weikequ/finch/issues/158)) ([e138f10](https://github.com/weikequ/finch/commit/e138f1053fe9219ae6584e49d38c43f306b75e6b))
* Correctly set and pick up environment variables ([#315](https://github.com/weikequ/finch/issues/315)) ([05227ce](https://github.com/weikequ/finch/commit/05227ce03055223bc7ffd10c634cc75a9632634e))
* error readable by using the right placeholder ([#39](https://github.com/weikequ/finch/issues/39)) ([8e5f38d](https://github.com/weikequ/finch/commit/8e5f38d2b994dadf53f57430eaa0a59b8cafd2f8))
* explicitly set permissions for socket_vmnet dependencies ([#363](https://github.com/weikequ/finch/issues/363)) ([0801b88](https://github.com/weikequ/finch/commit/0801b8841776e7a08d2a0826bbca535310b02f37))
* fix the misleading log when applying invalid config ([#119](https://github.com/weikequ/finch/issues/119)) ([b4f74c5](https://github.com/weikequ/finch/commit/b4f74c5a61f78034cc761ea3977b17e36a624692))
* ignore .ssh pub keys ([#109](https://github.com/weikequ/finch/issues/109)) ([0b74597](https://github.com/weikequ/finch/commit/0b745979ae142c73e3ef5be8d6fd31f142a5d6cd))
* parse --add-host special ip with equal sign ([#229](https://github.com/weikequ/finch/issues/229)) ([fb4b62b](https://github.com/weikequ/finch/commit/fb4b62bc6987ed786da8f1a351ea8200206be941))
* persists nerdctl user data ([#182](https://github.com/weikequ/finch/issues/182)) ([59f372c](https://github.com/weikequ/finch/commit/59f372cb0875f800015abe989d4eba6b8df92e42))
* persists network user data ([#211](https://github.com/weikequ/finch/issues/211)) ([f6baf82](https://github.com/weikequ/finch/commit/f6baf82171d6c487efb21bc0eb45d772124e04b2))
* print debug logs after newline ([#273](https://github.com/weikequ/finch/issues/273)) ([8faa7de](https://github.com/weikequ/finch/commit/8faa7de81bbb5eb222c5abb4b1239ef8b27e15cb))
* print debug logs when lima disk command fails ([#270](https://github.com/weikequ/finch/issues/270)) ([78a3f50](https://github.com/weikequ/finch/commit/78a3f5002e10442bf818015de55b940cd4bcf19d))
* sort volume args in DOCKER_COMPAT mode ([#417](https://github.com/weikequ/finch/issues/417)) ([6a8ca1a](https://github.com/weikequ/finch/commit/6a8ca1a559dada6ed320c9454fbc3229446a0a40))
* Stop lima process in postinstall and uninstall ([#438](https://github.com/weikequ/finch/issues/438)) ([975c4ee](https://github.com/weikequ/finch/commit/975c4ee42c1529673a51382c62c4096dc663f80a))
* switch from rootless containers to rootful containers ([#232](https://github.com/weikequ/finch/issues/232)) ([ae43a07](https://github.com/weikequ/finch/commit/ae43a0779c778cc3656724f84b5cdfd8ab087798))


### Experimental

* **feat:** enable Virtualization.framework and Rosetta ([#282](https://github.com/weikequ/finch/issues/282)) ([fd3bf19](https://github.com/weikequ/finch/commit/fd3bf19ae454b493fd7f9b1b85a5522881020af1))


### Build System or External Dependencies

* add local-core Makefile target ([#351](https://github.com/weikequ/finch/issues/351)) ([f86c56f](https://github.com/weikequ/finch/commit/f86c56f68273cc4d8c9584477793fc7efa148e76))
* clean up finch-core _output directory in clean target ([#290](https://github.com/weikequ/finch/issues/290)) ([4684a95](https://github.com/weikequ/finch/commit/4684a959205a1f701ede8b59e7822354cb7d0d70))
* **deps:** bump finch-core to 0.1.1 ([#93](https://github.com/weikequ/finch/issues/93)) ([3f3bce5](https://github.com/weikequ/finch/commit/3f3bce568ede67c8c54dd92212ec5882443c966f))
* **deps:** Bump github.com/containerd/containerd from 1.6.14 to 1.6.18 ([#223](https://github.com/weikequ/finch/issues/223)) ([7480222](https://github.com/weikequ/finch/commit/748022258bcdb9f25b41d64cdffdee250c9e6274))
* **deps:** Bump github.com/docker/docker from 23.0.1+incompatible to 23.0.2+incompatible ([#320](https://github.com/weikequ/finch/issues/320)) ([ee3df9a](https://github.com/weikequ/finch/commit/ee3df9a31e4ebab872001ba7756a81a49aaa9ad5))
* **deps:** Bump github.com/docker/docker from 23.0.2+incompatible to 23.0.3+incompatible ([#343](https://github.com/weikequ/finch/issues/343)) ([6cfbb9f](https://github.com/weikequ/finch/commit/6cfbb9ffa3a9bc3b3c06235dffbc6c7625d5aede))
* **deps:** Bump github.com/docker/docker from 23.0.3+incompatible to 23.0.5+incompatible ([#382](https://github.com/weikequ/finch/issues/382)) ([3e0581c](https://github.com/weikequ/finch/commit/3e0581cc0f86efcd9ce7b7dc8c9384fb1e6af785))
* **deps:** Bump github.com/docker/docker from 23.0.5+incompatible to 23.0.6+incompatible ([#394](https://github.com/weikequ/finch/issues/394)) ([f44bc2e](https://github.com/weikequ/finch/commit/f44bc2eb14011640f7a25218bbc18a82d533e76a))
* **deps:** Bump github.com/docker/docker from 23.0.6+incompatible to 24.0.0+incompatible ([#406](https://github.com/weikequ/finch/issues/406)) ([25aa324](https://github.com/weikequ/finch/commit/25aa324ca324248cf2093af23f205af1b5ae276f))
* **deps:** Bump github.com/docker/docker from 24.0.0+incompatible to 24.0.1+incompatible ([#413](https://github.com/weikequ/finch/issues/413)) ([bb1cab2](https://github.com/weikequ/finch/commit/bb1cab229c787752615eb00e74f240c4a4e0e23d))
* **deps:** Bump github.com/docker/docker from 24.0.1+incompatible to 24.0.2+incompatible ([#419](https://github.com/weikequ/finch/issues/419)) ([f6f8aeb](https://github.com/weikequ/finch/commit/f6f8aeb40fa0b2cfaa807c98eb3576ca262d75aa))
* **deps:** Bump github.com/google/go-licenses from 1.5.0 to 1.6.0 ([#168](https://github.com/weikequ/finch/issues/168)) ([bb5674c](https://github.com/weikequ/finch/commit/bb5674c846a094d06203449c83a90bd4eaf71a53))
* **deps:** Bump github.com/lima-vm/lima from 0.12.0 to 0.13.0 ([#40](https://github.com/weikequ/finch/issues/40)) ([520cc7f](https://github.com/weikequ/finch/commit/520cc7f06f9a98652fb077822f1a752da26f7bb9))
* **deps:** Bump github.com/lima-vm/lima from 0.13.0 to 0.14.0 ([#113](https://github.com/weikequ/finch/issues/113)) ([9b275bc](https://github.com/weikequ/finch/commit/9b275bc807ef6498c8bf38f49e8347b6e0f0b99b))
* **deps:** Bump github.com/lima-vm/lima from 0.14.0 to 0.14.1 ([#120](https://github.com/weikequ/finch/issues/120)) ([9dea794](https://github.com/weikequ/finch/commit/9dea79434e800cf72fa511195011f8fa04fc87d6))
* **deps:** Bump github.com/lima-vm/lima from 0.14.1 to 0.14.2 ([#130](https://github.com/weikequ/finch/issues/130)) ([26b7b09](https://github.com/weikequ/finch/commit/26b7b094814db88d500621b581ba8d6f676a21bc))
* **deps:** bump github.com/lima-vm/lima from 0.14.2 to 0.15.0 ([#247](https://github.com/weikequ/finch/issues/247)) ([007081e](https://github.com/weikequ/finch/commit/007081e6f1d07071b3e0535a87009f985702b2ee))
* **deps:** Bump github.com/lima-vm/lima from 0.15.0 to 0.15.1 ([#365](https://github.com/weikequ/finch/issues/365)) ([1d3ee98](https://github.com/weikequ/finch/commit/1d3ee985427e601bf3f5659c3bba13467ec01ce0))
* **deps:** Bump github.com/lima-vm/lima from 0.15.1 to 0.16.0 ([#428](https://github.com/weikequ/finch/issues/428)) ([6a67f0c](https://github.com/weikequ/finch/commit/6a67f0cfb0a3a1da438779f4faa04048f25d7dde))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.5.0 to 2.5.1 ([#50](https://github.com/weikequ/finch/issues/50)) ([fa108fd](https://github.com/weikequ/finch/commit/fa108fd958649578d08b20725ead6ce7a5a190db))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.5.1 to 2.6.0 ([#114](https://github.com/weikequ/finch/issues/114)) ([934521c](https://github.com/weikequ/finch/commit/934521c9bf763c0c4106394b40b158c89390b022))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.6.0 to 2.6.1 ([#121](https://github.com/weikequ/finch/issues/121)) ([becbc44](https://github.com/weikequ/finch/commit/becbc443a5084ad15e916b41f8aa0f28791b4973))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.7.0 to 2.7.1 ([#193](https://github.com/weikequ/finch/issues/193)) ([7aaa381](https://github.com/weikequ/finch/commit/7aaa381cebc0e5306fc78f0de576f4065eb89cd8))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.7.1 to 2.8.0 ([#200](https://github.com/weikequ/finch/issues/200)) ([596ed33](https://github.com/weikequ/finch/commit/596ed337f03a4a1f861aceaa6844b1acc55355aa))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.8.0 to 2.8.3 ([#233](https://github.com/weikequ/finch/issues/233)) ([1185372](https://github.com/weikequ/finch/commit/1185372b672e76373e4b7e798de9725bf6ecba50))
* **deps:** bump github.com/onsi/ginkgo/v2 from 2.8.3 to 2.8.4 ([#245](https://github.com/weikequ/finch/issues/245)) ([5e64716](https://github.com/weikequ/finch/commit/5e647165f7dfccd185d2c0fa94c565309a5a54b0))
* **deps:** bump github.com/onsi/ginkgo/v2 from 2.8.4 to 2.9.0 ([#265](https://github.com/weikequ/finch/issues/265)) ([7e2d49e](https://github.com/weikequ/finch/commit/7e2d49e8b09c4167a6e3ad5df4a6f6d9ab9ca728))
* **deps:** bump github.com/onsi/ginkgo/v2 from 2.9.0 to 2.9.1 ([#285](https://github.com/weikequ/finch/issues/285)) ([d741a03](https://github.com/weikequ/finch/commit/d741a03ac368673432a29f45f5fdaa6f6580fbc9))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.2 to 2.9.3 ([#390](https://github.com/weikequ/finch/issues/390)) ([7102994](https://github.com/weikequ/finch/commit/710299445ed287c67114b277be7bd2a29715956b))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.3 to 2.9.5 ([#400](https://github.com/weikequ/finch/issues/400)) ([65458f1](https://github.com/weikequ/finch/commit/65458f1b0c20705e724ac07356d87dd47ae2000c))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.5 to 2.9.7 ([#432](https://github.com/weikequ/finch/issues/432)) ([0a381f1](https://github.com/weikequ/finch/commit/0a381f17ea2602bc3b19f9b2101da9e3a589f6d3))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.7 to 2.10.0 ([#449](https://github.com/weikequ/finch/issues/449)) ([a415e3e](https://github.com/weikequ/finch/commit/a415e3ef7b2741853bf352b915c4100c77600619))
* **deps:** Bump github.com/onsi/gomega from 1.24.1 to 1.24.2 ([#122](https://github.com/weikequ/finch/issues/122)) ([d8174ff](https://github.com/weikequ/finch/commit/d8174ff773f0f92ec94d6d97c753a872a98f74a0))
* **deps:** Bump github.com/onsi/gomega from 1.24.2 to 1.25.0 ([#165](https://github.com/weikequ/finch/issues/165)) ([e4b9e96](https://github.com/weikequ/finch/commit/e4b9e96713feac19bc73dfc2dd788a80c28a064f))
* **deps:** Bump github.com/onsi/gomega from 1.25.0 to 1.26.0 ([#183](https://github.com/weikequ/finch/issues/183)) ([12661b7](https://github.com/weikequ/finch/commit/12661b789f6b9162392d698f07a69e34ae391ab8))
* **deps:** Bump github.com/onsi/gomega from 1.26.0 to 1.27.1 ([#234](https://github.com/weikequ/finch/issues/234)) ([cd43781](https://github.com/weikequ/finch/commit/cd43781b37750579905fc4e32d63f17ad1ec678f))
* **deps:** bump github.com/onsi/gomega from 1.27.1 to 1.27.2 ([#246](https://github.com/weikequ/finch/issues/246)) ([863c51e](https://github.com/weikequ/finch/commit/863c51e7262e720a93cfea90cf01b0477fd1a2d2))
* **deps:** Bump github.com/onsi/gomega from 1.27.3 to 1.27.5 ([#312](https://github.com/weikequ/finch/issues/312)) ([e078234](https://github.com/weikequ/finch/commit/e07823454ba86701ff7316e8c44e78d1c5ceb454))
* **deps:** Bump github.com/onsi/gomega from 1.27.5 to 1.27.6 ([#331](https://github.com/weikequ/finch/issues/331)) ([fe388a3](https://github.com/weikequ/finch/commit/fe388a31f830f854abacb06729ddf710040e9e62))
* **deps:** Bump github.com/onsi/gomega from 1.27.6 to 1.27.7 ([#409](https://github.com/weikequ/finch/issues/409)) ([80513c7](https://github.com/weikequ/finch/commit/80513c7785a6da4ae09d9c871acaf180f5d68f2c))
* **deps:** Bump github.com/onsi/gomega from 1.27.7 to 1.27.8 ([#448](https://github.com/weikequ/finch/issues/448)) ([96fc8d0](https://github.com/weikequ/finch/commit/96fc8d09a051b2ead932e6eef064624b1a842b66))
* **deps:** Bump github.com/runfinch/common-tests from 0.1.1 to 0.2.0 ([#125](https://github.com/weikequ/finch/issues/125)) ([1bac92a](https://github.com/weikequ/finch/commit/1bac92a99f2e031792018dedfb6425488af51f1e))
* **deps:** Bump github.com/runfinch/common-tests from 0.2.0 to 0.3.0 ([#151](https://github.com/weikequ/finch/issues/151)) ([79df04e](https://github.com/weikequ/finch/commit/79df04ef62df615c19070e607a060769ab09e7a0))
* **deps:** Bump github.com/runfinch/common-tests from 0.5.0 to 0.6.0 ([#235](https://github.com/weikequ/finch/issues/235)) ([4a33a2e](https://github.com/weikequ/finch/commit/4a33a2e63c72e687030c70b13dcc5c5748606b86))
* **deps:** bump github.com/runfinch/common-tests from 0.6.1 to 0.6.2 ([#300](https://github.com/weikequ/finch/issues/300)) ([dd626a0](https://github.com/weikequ/finch/commit/dd626a024203ec28bba46bf1e1c65b1b6644334d))
* **deps:** Bump github.com/runfinch/common-tests from 0.6.4 to 0.6.5 ([#357](https://github.com/weikequ/finch/issues/357)) ([dc84864](https://github.com/weikequ/finch/commit/dc848640b719c623dbf606439e6e3e1d9dcd02d6))
* **deps:** Bump github.com/runfinch/common-tests from 0.6.5 to 0.7.0 ([#420](https://github.com/weikequ/finch/issues/420)) ([ac18046](https://github.com/weikequ/finch/commit/ac18046e70efc0e1e9fe11a30457f6f945df2a23))
* **deps:** Bump github.com/runfinch/common-tests version from v0.1.0 to v0.1.1 ([#76](https://github.com/weikequ/finch/issues/76)) ([fd22d4a](https://github.com/weikequ/finch/commit/fd22d4afafd387eda404a7286952f85c80fa5418))
* **deps:** Bump github.com/runfinch/common-tests version from v0.3.0 to v0.3.1 ([#169](https://github.com/weikequ/finch/issues/169)) ([16157fe](https://github.com/weikequ/finch/commit/16157fe3adfc8be19899700ae3f1cd5c1a848304))
* **deps:** Bump github.com/runfinch/common-tests version from v0.6.2 to v0.6.3 ([#328](https://github.com/weikequ/finch/issues/328)) ([1c44b3e](https://github.com/weikequ/finch/commit/1c44b3e270aa2e2ebb237e86f17f3a9519ec124b))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.3 to 3.23.4 ([#389](https://github.com/weikequ/finch/issues/389)) ([76b31c0](https://github.com/weikequ/finch/commit/76b31c0c453935f22588523f65888e103581cd89))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.4 to 3.23.5 ([#437](https://github.com/weikequ/finch/issues/437)) ([8635294](https://github.com/weikequ/finch/commit/8635294bcb22207bfdaa3f96756f93ba580ff6e2))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.0 to 1.9.1 ([#405](https://github.com/weikequ/finch/issues/405)) ([05b6b2e](https://github.com/weikequ/finch/commit/05b6b2e7364036a3d30b67ad409f55526cc59ffe))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.1 to 1.9.2 ([#408](https://github.com/weikequ/finch/issues/408)) ([0ff477a](https://github.com/weikequ/finch/commit/0ff477ab32e2c427bbc800b6ae65efc72b5ed1eb))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.2 to 1.9.3 ([#446](https://github.com/weikequ/finch/issues/446)) ([1823677](https://github.com/weikequ/finch/commit/18236774d971065dec28d1db204e1f697d418a9b))
* **deps:** Bump github.com/spf13/afero from 1.9.2 to 1.9.3 ([#43](https://github.com/weikequ/finch/issues/43)) ([bf0ad84](https://github.com/weikequ/finch/commit/bf0ad849a90ded53b66b01031e1960bd7803b224))
* **deps:** Bump github.com/spf13/afero from 1.9.3 to 1.9.4 ([#241](https://github.com/weikequ/finch/issues/241)) ([58f26e6](https://github.com/weikequ/finch/commit/58f26e66be84cc6e566960fd81276fff5ee124c0))
* **deps:** bump github.com/spf13/afero from 1.9.4 to 1.9.5 ([#263](https://github.com/weikequ/finch/issues/263)) ([a0e277f](https://github.com/weikequ/finch/commit/a0e277f8cba008e2422d11fac26f33640a2ab160))
* **deps:** Bump github.com/spf13/cobra from 1.6.1 to 1.7.0 ([#341](https://github.com/weikequ/finch/issues/341)) ([6a77f72](https://github.com/weikequ/finch/commit/6a77f721f35779bd112d5e1206bf034940a43a23))
* **deps:** Bump github.com/stretchr/testify from 1.8.0 to 1.8.1 ([#44](https://github.com/weikequ/finch/issues/44)) ([31c6d70](https://github.com/weikequ/finch/commit/31c6d70748b9346c9468e3f2882f7e6b8b27bd6b))
* **deps:** bump github.com/stretchr/testify from 1.8.1 to 1.8.2 ([#244](https://github.com/weikequ/finch/issues/244)) ([984af70](https://github.com/weikequ/finch/commit/984af7008db46eb9e4eecac3050d05f6f76ebcca))
* **deps:** Bump github.com/stretchr/testify from 1.8.2 to 1.8.4 ([#429](https://github.com/weikequ/finch/issues/429)) ([0f7750e](https://github.com/weikequ/finch/commit/0f7750ebeee01108a9f6a6fcfe0c7f5f044bc336))
* **deps:** Bump github.com/xorcare/pointer from 1.2.1 to 1.2.2 ([#42](https://github.com/weikequ/finch/issues/42)) ([8e83137](https://github.com/weikequ/finch/commit/8e83137a1cd12fe1d47187bb96e362ec8d34ca4b))
* **deps:** Bump golang.org/x/crypto from 0.1.0 to 0.3.0 ([#49](https://github.com/weikequ/finch/issues/49)) ([89826cf](https://github.com/weikequ/finch/commit/89826cf141253746395259438788bb6150410727))
* **deps:** Bump golang.org/x/crypto from 0.3.0 to 0.4.0 ([#102](https://github.com/weikequ/finch/issues/102)) ([d2778e3](https://github.com/weikequ/finch/commit/d2778e3b2b123f1e7882920f16c4d91f9f96304e))
* **deps:** Bump golang.org/x/crypto from 0.4.0 to 0.5.0 ([#138](https://github.com/weikequ/finch/issues/138)) ([8d06eec](https://github.com/weikequ/finch/commit/8d06eecdc94fb284da6f6587ba031a898d30ba5f))
* **deps:** Bump golang.org/x/crypto from 0.4.0 to 0.5.0 ([#144](https://github.com/weikequ/finch/issues/144)) ([603419a](https://github.com/weikequ/finch/commit/603419a703154e8a8eac404da2b9aeb76c5b3333))
* **deps:** Bump golang.org/x/crypto from 0.5.0 to 0.6.0 ([#212](https://github.com/weikequ/finch/issues/212)) ([e1a36cf](https://github.com/weikequ/finch/commit/e1a36cf9ff39c1273761ca810e357e6200f31de8))
* **deps:** bump golang.org/x/crypto from 0.6.0 to 0.7.0 ([#264](https://github.com/weikequ/finch/issues/264)) ([ec1c07f](https://github.com/weikequ/finch/commit/ec1c07ff3567396fb0f5a461ece2b048133cce68))
* **deps:** Bump golang.org/x/crypto from 0.7.0 to 0.8.0 ([#349](https://github.com/weikequ/finch/issues/349)) ([82b27c9](https://github.com/weikequ/finch/commit/82b27c9bb1424ef47fe05cf805aebc337af3bc5e))
* **deps:** Bump golang.org/x/crypto from 0.8.0 to 0.9.0 ([#397](https://github.com/weikequ/finch/issues/397)) ([f15c2ee](https://github.com/weikequ/finch/commit/f15c2ee576416c0cb25de45438bd894ca6b1fdcb))
* **deps:** Bump golang.org/x/crypto from 0.9.0 to 0.10.0 ([#451](https://github.com/weikequ/finch/issues/451)) ([fef6e77](https://github.com/weikequ/finch/commit/fef6e772c28429ef14068702c1dfd8e9fec2dea1))
* **deps:** Bump golang.org/x/tools from 0.2.0 to 0.3.0 ([#52](https://github.com/weikequ/finch/issues/52)) ([27c8f24](https://github.com/weikequ/finch/commit/27c8f24aa1219d397e67f264a45cdcd96e5a23a5))
* **deps:** Bump golang.org/x/tools from 0.3.0 to 0.4.0 ([#101](https://github.com/weikequ/finch/issues/101)) ([b3c4df1](https://github.com/weikequ/finch/commit/b3c4df1e65bfc95b120b243c2c10463436994d06))
* **deps:** Bump golang.org/x/tools from 0.4.0 to 0.5.0 ([#139](https://github.com/weikequ/finch/issues/139)) ([89194dc](https://github.com/weikequ/finch/commit/89194dc52757d8f30a8fe8621115e184299bf3e7))
* **deps:** Bump golang.org/x/tools from 0.5.0 to 0.6.0 ([#215](https://github.com/weikequ/finch/issues/215)) ([decf250](https://github.com/weikequ/finch/commit/decf250bae9e1cce8c0cb78daee62e7160fc0027))
* **deps:** bump golang.org/x/tools from 0.6.0 to 0.7.0 ([#268](https://github.com/weikequ/finch/issues/268)) ([8072e39](https://github.com/weikequ/finch/commit/8072e39172831c8f3c18b8d17b186ec4a421d830))
* **deps:** Bump golang.org/x/tools from 0.7.0 to 0.8.0 ([#348](https://github.com/weikequ/finch/issues/348)) ([aaca2c9](https://github.com/weikequ/finch/commit/aaca2c994a2c146e751c43fbb4fabb78041da98d))
* **deps:** Bump golang.org/x/tools from 0.9.1 to 0.9.3 ([#443](https://github.com/weikequ/finch/issues/443)) ([b192874](https://github.com/weikequ/finch/commit/b192874e2b1c5de1c2148813760cbe65e15d7553))
* **deps:** Bump k8s.io/apimachinery from 0.25.2 to 0.25.4 ([#51](https://github.com/weikequ/finch/issues/51)) ([8f15779](https://github.com/weikequ/finch/commit/8f157797cdfedda17cca36fe0a5458a582e7b4a2))
* **deps:** Bump k8s.io/apimachinery from 0.25.4 to 0.26.0 ([#115](https://github.com/weikequ/finch/issues/115)) ([e9084a4](https://github.com/weikequ/finch/commit/e9084a413330799ed01da94f826518f30f33a83b))
* **deps:** Bump k8s.io/apimachinery from 0.26.0 to 0.26.1 ([#174](https://github.com/weikequ/finch/issues/174)) ([829b0bc](https://github.com/weikequ/finch/commit/829b0bc05824203e60609264c18d075c1eea845b))
* **deps:** bump k8s.io/apimachinery from 0.26.1 to 0.26.2 ([#251](https://github.com/weikequ/finch/issues/251)) ([4a7268e](https://github.com/weikequ/finch/commit/4a7268ede5d6f9d2fc3e30f167d2a4ebc91bb5f2))
* **deps:** bump k8s.io/apimachinery from 0.26.2 to 0.26.3 ([#306](https://github.com/weikequ/finch/issues/306)) ([fe392cb](https://github.com/weikequ/finch/commit/fe392cb07cb4ca50b064bbb6f6667b7942047ffb))
* **deps:** Bump k8s.io/apimachinery from 0.26.3 to 0.27.1 ([#366](https://github.com/weikequ/finch/issues/366)) ([b93d3a8](https://github.com/weikequ/finch/commit/b93d3a8ed8eef42321200ac1386b61765e0b8348))
* **deps:** Bump k8s.io/apimachinery from 0.27.1 to 0.27.2 ([#407](https://github.com/weikequ/finch/issues/407)) ([e6cbd2c](https://github.com/weikequ/finch/commit/e6cbd2c5dba8af5cab9ea8a37a33c580ee4edef9))
* **deps:** Bump lima version ([#141](https://github.com/weikequ/finch/issues/141)) ([35da07d](https://github.com/weikequ/finch/commit/35da07d7cc65fe5749a7eb665413824cf3115a08))
* **deps:** Bump lima version ([#302](https://github.com/weikequ/finch/issues/302)) ([0269743](https://github.com/weikequ/finch/commit/026974314254df1e4047ea5130ba50464608bb1d))
* **deps:** Bump lima version ([#354](https://github.com/weikequ/finch/issues/354)) ([c721ee6](https://github.com/weikequ/finch/commit/c721ee69f470eaf81b24fc043f088713fce88ad6))
* **deps:** Bump lima version ([#362](https://github.com/weikequ/finch/issues/362)) ([5e03a4d](https://github.com/weikequ/finch/commit/5e03a4d40c63a8fcc5a79bdda2ebfec6f993db3c))
* **deps:** Bump lima version ([#368](https://github.com/weikequ/finch/issues/368)) ([8e4dfe4](https://github.com/weikequ/finch/commit/8e4dfe4092a959d853549ed980e1c36a9e630be8))
* **deps:** Bump lima version ([#75](https://github.com/weikequ/finch/issues/75)) ([cfaa4f6](https://github.com/weikequ/finch/commit/cfaa4f6b79af2eba3cfceff0b0e65f44329d1e78))
* **deps:** Bump submodules ([#281](https://github.com/weikequ/finch/issues/281)) ([d4fd1f6](https://github.com/weikequ/finch/commit/d4fd1f6902d51985c829808c65738e38f7e2cdd1))
* **deps:** Bump submodules ([#304](https://github.com/weikequ/finch/issues/304)) ([b38af9f](https://github.com/weikequ/finch/commit/b38af9fe0e5c4ffb3eb94641d70dd16e3fe7c833))
* **deps:** Bump submodules ([#307](https://github.com/weikequ/finch/issues/307)) ([1a914ec](https://github.com/weikequ/finch/commit/1a914ec11c9fcbbb56982c3361a3716ab7a946b2))
* **deps:** Bump submodules ([#319](https://github.com/weikequ/finch/issues/319)) ([e671224](https://github.com/weikequ/finch/commit/e671224bdb87983bce0db6e797ccfe71fb5dfc63))
* **deps:** Bump submodules ([#332](https://github.com/weikequ/finch/issues/332)) ([5923ae2](https://github.com/weikequ/finch/commit/5923ae2933e6cb2e9bf9e74db4584679af56c471))
* **deps:** Bump submodules ([#340](https://github.com/weikequ/finch/issues/340)) ([daed9e2](https://github.com/weikequ/finch/commit/daed9e24228b82b6d45c2eb43e86101b2a4420c9))
* **deps:** Bump submodules ([#371](https://github.com/weikequ/finch/issues/371)) ([19fc0c5](https://github.com/weikequ/finch/commit/19fc0c5d16a6d2fb876b05575420a8080c8a3562))
* **deps:** Bump submodules ([#375](https://github.com/weikequ/finch/issues/375)) ([70fe4c3](https://github.com/weikequ/finch/commit/70fe4c3e0320f237d2e4501fbe2bc4d3320ef3e9))
* **deps:** Bump submodules ([#402](https://github.com/weikequ/finch/issues/402)) ([06d86b2](https://github.com/weikequ/finch/commit/06d86b2bc348db9f0d8d02678faee556719b883d))
* **deps:** Bump submodules ([#439](https://github.com/weikequ/finch/issues/439)) ([e9551b5](https://github.com/weikequ/finch/commit/e9551b50010deb43ad26dcd3671ec2f246e84ed6))
* make finch-core a submodule instead of downloading archives ([#188](https://github.com/weikequ/finch/issues/188)) ([b08f588](https://github.com/weikequ/finch/commit/b08f588cd13b7a1a7c457f279b74489e9df09fb5))
* update os image versions ([#255](https://github.com/weikequ/finch/issues/255)) ([576765b](https://github.com/weikequ/finch/commit/576765b2913b714d274bc1ab8b418f9ce9421b9d))
